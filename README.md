...
- 이런 방식을 선택한 이유는 다음과 같습니다.
    1. 익숙하지 않은 api에 적응
        ...
        - 실제 활용 사례를 참조하는 것을 통해 api를 어떻게 사용할 수 있는지 간접 경험하여, 혼자서 api를 분석하는 것보다 빠르게 적응하는데 도움이 될 것이라 판단했습니다.
    2. 시간 절약
...
- 이번 프로젝트를 통해 당초 목표로 했던 3가지 경험을 쌓을 수 있었습니다.
    - Drag event api 사용 경험 쌓기
        ...
        - 아쉬운 점은 위 ‘해결이 필요한 문제’에 작성한 것처럼 사용자 역할이 너무 과도하게 구현된 것 같다는 점입니다. 추후 각 Custom Hook을 좀 더 간단하게 구현해 사용자들이 간편하게 사용할 수 있도록 만드는 것이 필요해 보입니다.
    ...
    - 패키지 매니저로 설치 가능한 라이브러리 제작 경험 쌓기
        - 패키지 매니저로 설치 가능한 형태로 만드는 것은 [yalc 라이브러리](https://www.npmjs.com/package/yalc)를 이용했습니다.
